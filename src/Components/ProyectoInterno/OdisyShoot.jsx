    ...
    return (
        <>
            <div className='container mx-auto border-b border-azulbrillante pb-[17px] px-2'>
                <h1 className="font-bold font-Oswald uppercase text-naranjo text-[70px] sm:text-h1pagina mt-28">Odisy Shoot</h1>
                <h2 className="text-white font-medium font-Oswald text-[42px]">Videojuego shoot 'em up 3D</h2>
            </div>
