        ...
        <>
            ...
            <form className="container mx-auto">
                <div className="">
                    ...
                    <div className="flex justify-center">
                        <button type="submit" class="h-[38px] max-w-2xl w-full mt-[21px] border-2 border-azulbrillante font-bold font-Inter text-azulbrillante text-[15px]">Enviar</button>
                    </div>
                </div>
             </form>
        </>
